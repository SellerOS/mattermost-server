...
func TestCreateOrRestoreGroupMember(t *testing.T) {
	...
	g, err := th.App.CreateOrRestoreGroupMember(group.Id, th.BasicUser.ClientId)
	require.Nil(t, err)
	require.NotNil(t, g)
...
func TestDeleteGroupMember(t *testing.T) {
	...
	defer th.TearDown()
	group := th.CreateGroup()
	groupMember, err := th.App.CreateOrRestoreGroupMember(group.Id, th.BasicUser.ClientId)
	require.Nil(t, err)
