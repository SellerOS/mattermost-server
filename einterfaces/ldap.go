...
type LdapInterface interface {
	DoLogin(id string, password string) (*model.UserIms, *model.AppError)
	GetUser(id string) (*model.UserIms, *model.AppError)
	...
	GetAllLdapUsers() ([]*model.UserIms, *model.AppError)
